...
const menuItems = [
  ...
  {
    id: 'admin-rights', label: 'Admin Rights', path: '#', icon: <LucideShieldCheck size={20} />,
    submenu: [
      { id: 'company-master', label: 'Company Master', path: '/company-master' },
      { id: 'company-access', label: 'Company Access', path: '/company-access' },
    ]
  },
  {
    id: 'product-config', label: 'Product Config', path: '#', icon: <LucideBox size={20} />,
    submenu: [
      { id: 'product-master', label: 'Product Master', path: '/product-master' },
      { id: 'price-master', label: 'Price Master', path: '/price-master' },
      { id: 'category-master', label: 'Category Master', path: '/category-master' },
      { id: 'product-allocation', label: 'Product Allocation', path: '/product-allocation' },
      { id: 'product-details', label: 'Product Details', path: '/product-details' }
    ]
  },
  {
    id: 'loyalty-management', label: 'Loyalty Management', path: '#', icon: <LucideTag size={20} />,
    submenu: [
      { id: 'loyalty-scheme-master', label: 'Loyalty Scheme Master', path: '/loyalty-scheme-master' },
      { id: 'scheme-product-mapping', label: 'Scheme Product Mapping', path: '/scheme-product-mapping' },
      { id: 'catalogue-master', label: 'Catalogue Master', path: '/catalogue-master' },
      { id: 'lucky-draw', label: 'Lucky Draw', path: '/lucky-draw' },
      { id: 'redemption-approval', label: 'Redemption Approval', path: '/redemption-approval' }
    ]
  },
  {
    id: 'data-management', label: 'Data Management', path: '#', icon: <LucideDatabase size={20} />,
    submenu: [
      { id: 'issue-number', label: 'Issue Number', path: '/issue-number' },
      { id: 'generate-numbers', label: 'Generate Numbers', path: '/generate-numbers' },
      { id: 'qr-code-return', label: 'QR-Code Return', path: '/qr-code-return' },
      { id: 'qr-code-damage', label: 'QR-Code Damage', path: '/qr-code-damage' }
    ]
  },
  {
    id: 'manage-warranty', label: 'Manage Warranty', path: '#', icon: <LucideSettings size={20} />,
    submenu: [
      { id: 'warranty-registration', label: 'Warranty Registration', path: '/warranty-registration' },
      { id: 'warranty-approval', label: 'Warranty Approval', path: '/warranty-approval' },
      { id: 'warranty-enquiry', label: 'Warranty Enquiry', path: '/warranty-enquiry' }
    ]
  }
];
